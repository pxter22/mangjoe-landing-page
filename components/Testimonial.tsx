  ...
  return (
    <section className="relative py-12 sm:py-16 md:py-20 lg:py-24 xl:py-28 overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <span className="text-4xl md:text-5xl font-semibold text-gray-200">4.6</span>
          ...
          <span className="text-gray-400 text-base md:text-lg">28 reviews</span>
        </motion.div>
