...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Yes. Food prepared at Mang Joe's contains traces of sesame, fish, mollusc, and peanuts. Please avoid consuming our food if you are allergic to any of these ingredients. Additionally, please ensure you notify us if you have any allergies or dietary restrictions.",
    category: "general",
    icon: (
      <svg
        className="w-5 h-5"
  ...
  },
  {
    ...
    answer:
      "Follow us on Facebook to get the latest updates on locations and events we'll be attending. You can also contact us directly to inquire about our availability.",
    category: "food-truck",
    icon: (
      <svg
        className="w-5 h-5"
  ...
  },
  {
    ...
    answer:
      "No, you don't need to book a table since we operate in a food court. However, the food court has rush hours, so availability and wait times may vary.",
    category: "food-court",
    icon: (
      <svg
        className="w-5 h-5"
  ...
  },
  {
    ...
    answer:
      "Since we operate in a food court, we don't accept pre-orders. We are available for walk-ins and we're on Uber Eats.",
    category: "food-court",
    icon: (
      <svg
        className="w-5 h-5"
  ...
  },
  {
    ...
    answer:
      "Yes, we accept most major credit and debit cards. We also accept cash.",
    category: "general",
    icon: (
      <svg
        className="w-5 h-5"
  ...
  },
  {
    ...
    answer:
      "Our weekly specials may include Chop Suey, a delicious stir-fried vegetable dish. Availability varies depending on the day.",
    category: "general",
    icon: (
      <svg
        className="w-5 h-5"
  ...
  },
  {
    ...
    answer:
      "Yes, we offer catering services for events and parties. Please contact us directly to inquire about our catering options.",
    category: "food-court",
    icon: (
      <svg
        className="w-5 h-5"
  ...
  },
  {
    ...
    answer: "No, sorry we do not have gluten-free options.",
    category: "general",
    icon: (
      <svg
        className="w-5 h-5"
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-bbq-charcoal-medium px-4 max-w-2xl mx-auto">
            These are the most commonly asked questions about Mang Joe&apos;s.
                ...
                return (
                  <motion.div
                    ...
                    className={`bg-white rounded-lg border transition-all duration-300 overflow-hidden ${
                      isOpen
                        ? "border-gray-200"
                        : "border-gray-200 hover:border-bbq-orange-rich"
                    }`}
                  >
                    <button
